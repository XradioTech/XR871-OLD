...
#define FD_SUPPORT 0
#define ID3_IOT_IMPLEMENT 1
#define LIVEMODE_VIDEO 0
#define SOUNDCTRL_NULL 0
#define CAPTURECTRL_NULL 0
#define CDX_IOT_AWPOOL 0
#define CDX_IOT_OLD_SOCKET 0
#define CDX_IOT_DNS_CACHE 0
#define CDX_IOT_CMCC_LOG 0
#define CDX_LWIP_SELECT_ERR 0
