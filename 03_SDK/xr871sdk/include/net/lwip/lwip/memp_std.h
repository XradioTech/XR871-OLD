...
LWIP_PBUF_MEMPOOL(PBUF_POOL, PBUF_POOL_SIZE,           PBUF_POOL_BUFSIZE+MBUF_HEAD_SPACE+MBUF_TAIL_SPACE,             "PBUF_POOL")
#if LWIP_PBUF_POOL_SMALL
LWIP_PBUF_MEMPOOL(PBUF_POOL_SMALL, PBUF_POOL_SMALL_SIZE, PBUF_POOL_SMALL_BUFSIZE+MBUF_HEAD_SPACE+MBUF_TAIL_SPACE,     "PBUF_POOL_SMALL")
